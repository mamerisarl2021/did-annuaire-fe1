              ...
              <TableCell className="text-right">
                ...
                >
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>Fetch public keys</TooltipContent>
                  </Tooltip>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        className={`h-8 gap-1.5 border-emerald-100 dark:border-emerald-900/40 ${
                          did.status !== "DRAFT" &&
                          !(did.status === "ACTIVE" && did.state === "action")
                    ...
                    <TooltipContent>Publish DID</TooltipContent>
                  </Tooltip>
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button
                          ...
                          variant="outline"
                          disabled
                          className="h-8 gap-1.5 text-slate-300 border-slate-200 dark:border-slate-800 cursor-not-allowed opacity-50"
                        >
                          <Edit className="size-4" />
                          <span className="hidden lg:inline text-[11px] font-bold">Update</span>
                        </Button>
                      </TooltipTrigger>
                      <TooltipContent>Cannot update deactivated DID</TooltipContent>
                    </Tooltip>
                  ) : (
                    <Tooltip>
                      <TooltipTrigger asChild>
                      ...
                      <TooltipContent>Update DID</TooltipContent>
                    </Tooltip>
                  )}
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      {did.status !== "ACTIVE" ? "DID already deactivated" : "Deactivate DID"}
                    </TooltipContent>
                  </Tooltip>
                </div>
              </TableCell>
