...
export function UserDeactivateModal({ isOpen, onClose, onConfirm, user }: UserDeactivateModalProps) {
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    ...
                    <DialogTitle className="text-center">{isActive ? "Deactivate" : "Reactivate"} User</DialogTitle>
                    <DialogDescription className="text-center">
                        Are you sure you want to {isActive ? "deactivate" : "reactivate"} <strong>{user.first_name} {user.last_name}</strong>?
